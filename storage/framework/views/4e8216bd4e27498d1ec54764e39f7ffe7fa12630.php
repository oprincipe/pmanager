                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="company-name"><i class="fa fa-user"></i> Name <span
                                    ...
                                    <div class="form-group">
                                        <label for="company-contactName"><i class="fa fa-user"></i> Contact name <span
                                                    class="required">*</span></label>
                                        <input type="text" class="form-control" name="contactName"
                                               id="company-contactName" placeholder="Company contactName"
                                    ...
                                    <div class="form-group">
                                        <label for="company-website"><i class="fa fa-external-link"></i> Website
                                        </label>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    ...
                                    <span class="pull-right clickable" style="margin-top: -18px"><i
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tel" id="company-tel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="fax" id="company-fax"
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pec" id="company-pec"
                                               placeholder="Company pec"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="skype" id="company-skype"
                                               placeholder="Company skype"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ol class="list-unstyled">
                            <li><a href="<?php echo e(URL::to('/companies/'.$company->id)); ?>"><i class="fa fa-info"></i> View
                                                                                                               company</a>
                            </li>
