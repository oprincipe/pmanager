                ...
                <div class="panel-body">
                    ...
                    <ul class="list-unstyled">
                        <?php if(!empty($company->website)): ?>
                            <li><a href="<?php echo e(URL::to($company->website)); ?>" target="_blank"><i class="fa fa-external-link"></i> <?php echo e($company->website); ?></a></li>
                        <?php endif; ?>
                        <?php if(!empty($company->contactName)): ?><li><i class="fa fa-user"></i> <?php echo e($company->contactName); ?></li><?php endif; ?>
                        <?php if(!empty($company->tel)): ?><li><a href="tel:+39<?php echo e($company->tel); ?>"><i class="fa fa-phone"></i> <?php echo e($company->tel); ?></a></li><?php endif; ?>
                        <?php if(!empty($company->email)): ?><li><a href="mailto:<?php echo e($company->email); ?>"><i class="fa fa-envelope"></i> <?php echo e($company->email); ?></a></li><?php endif; ?>
                        <?php if(!empty($company->pec)): ?><li><a href="mailto:<?php echo e($company->pec); ?>"><i class="fa fa-envelope-square"></i> <?php echo e($company->pec); ?></a></li><?php endif; ?>
                        <?php if(!empty($company->skype)): ?><li><a href="skype:<?php echo e($company->skype); ?>?chat"><i class="fa fa-skype"></i> <?php echo e($company->skype); ?></a></li><?php endif; ?>
                    </ul>
                    </p>
                </div>
            </div>
                                ...
                                <?php $__currentLoopData = $company->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-nowrap">
                                            ...
                                            <form id="delete-project-<?php echo e($project->id); ?>" action="<?php echo e(route("projects.destroy", [$project->id])); ?>"
                                        ...
                                        <td>
                                            ...
                                            <?php if(!empty($project->description)): ?>
                                                <p><i><?php echo \Illuminate\Support\Str::words($project->description, 10, '...'); ?></i></p>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-nowrap col-xs-3">
                                            ...
                                            <?php $__currentLoopData = $task_statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <?php echo e($tasks_count = $project->tasks_count($task_status->id)); ?>
    ...
    <div class="pull-right col-xs-3 col-sm-3 col-md-3 col-lg-3 blog-sidebar">
        ...
        <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
                ...
                <li><a href="<?php echo e(URL::to('/companies/'.$company->id.'/edit')); ?>"><i class="fa fa-pencil-square-o"></i> Edit</a></li>
                <li><a href="<?php echo e(URL::to('/projects/create/'.$company->id)); ?>"><i class="fa fa-plus"></i> Add project</a></li>
