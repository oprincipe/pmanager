                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('customer.login.submit') }}">
                        ...
                        <div class="form-group{{ $errors->has('supplier_code') ? ' has-error' : '' }}">
                            <label for="supplier_code" class="col-md-4 control-label">Supplier code</label>

                            <div class="col-md-6">
                                <input id="supplier_code" type="text" class="form-control"
                                       name="supplier_code" value="{{ old('supplier_code') }}" required autofocus>
