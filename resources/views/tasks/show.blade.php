            ...
            <div class="row col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <b><i class="fa fa-info"></i>
                                Status:</b> {!! $task->status->icon() !!} {{ $task->status->name }}
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ol class="list-unstyled">
                        ...
                        <li><a href="{{ URL::to('/companies/'.$task->company_id) }}"><i class="fa fa-building"></i> View
                                                                                                                    company</a>
                        </li>
                        <li><a href="{{ URL::to('/projects/'.$task->project_id) }}"><i class="fa fa-briefcase"></i> View
                                                                                                                    project</a>
                        </li>
