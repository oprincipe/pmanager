    ...
    <div class="pull-right col-xs-3 col-sm-3 col-md-3 col-lg-3 blog-sidebar">
        ...
        <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
                <li><a href="{{ URL::to('/projects/'.$project->id) }}"><i class="fa fa-briefcase"></i> View project</a></li>
                <li><a href="{{ URL::to('/companies/'.$project->company->id) }}"><i class="fa fa-building"></i> View company</a></li>
                <li><a href="{{ URL::to('/companies/') }}"><i class="fa fa-building-o"></i> All companies</a></li>
            </ol>
        </div>
